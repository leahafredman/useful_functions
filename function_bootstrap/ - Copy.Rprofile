...
if(!require('dplyr')) install.packages("", repos = 'http://cran.us.r-project.org'); library('')
...
if(!require('psyc')) install.packages("psyc", repos = 'http://cran.us.r-project.org'); library('psyc')
